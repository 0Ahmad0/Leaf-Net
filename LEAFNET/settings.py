"""
Django settings for LEAFNET project.
...
SECRET_KEY = 'django-insecure-=_5_+n&*cfv2%v7lchbs6xpowm++x%#$dt023k+nh=7wd=8+ip'
...
WSGI_APPLICATION = 'LEAFNET.wsgi.application'
